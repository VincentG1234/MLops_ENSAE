...
def query_database_agent(
    query_text=None, model_embedding=None, tokenizer_embedding=None, chat_history=None
):
    ...
    prompt = PROMPT_TEMPLATE.format(
        context=context_text, history=history_text, question=query_text
    )
...
def search_knn(index, query_vector, n, k=3):
    ...
    return (
        indices_with_neighbors  # Retourne les indices des passages les plus pertinents
    )
